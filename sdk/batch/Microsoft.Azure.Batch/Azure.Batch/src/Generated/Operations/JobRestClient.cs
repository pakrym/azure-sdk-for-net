...
namespace Azure.Batch
{
    internal partial class JobRestClient
    {
        ...
        public JobRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string batchUrl, string apiVersion = "2020-03-01.11.0")
        {
            if (batchUrl == null)
            {
        ...
        public async ValueTask<ResponseWithHeaders<JobStatistics, GetAllLifetimeStatisticsHeaders>> GetAllLifetimeStatisticsAsync(JobGetAllLifetimeStatisticsOptions jobGetAllLifetimeStatisticsOptions, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="jobGetAllLifetimeStatisticsOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<JobStatistics, GetAllLifetimeStatisticsHeaders> GetAllLifetimeStatistics(JobGetAllLifetimeStatisticsOptions jobGetAllLifetimeStatisticsOptions, CancellationToken cancellationToken = default)
        {
            using var scope = clientDiagnostics.CreateScope("JobClient.GetAllLifetimeStatistics");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<DeleteHeaders>> DeleteAsync(string jobId, JobDeleteOptions jobDeleteOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
        ...
        /// <param name="jobDeleteOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<DeleteHeaders> Delete(string jobId, JobDeleteOptions jobDeleteOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<CloudJob, GetHeaders>> GetAsync(string jobId, JobGetOptions jobGetOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
            ...
            using var scope = clientDiagnostics.CreateScope("JobClient.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="jobGetOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<CloudJob, GetHeaders> Get(string jobId, JobGetOptions jobGetOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<PatchHeaders>> PatchAsync(string jobId, JobPatchParameter jobPatchParameter, JobPatchOptions jobPatchOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="jobPatchOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<PatchHeaders> Patch(string jobId, JobPatchParameter jobPatchParameter, JobPatchOptions jobPatchOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<UpdateHeaders>> UpdateAsync(string jobId, JobUpdateParameter jobUpdateParameter, JobUpdateOptions jobUpdateOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="jobUpdateOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<UpdateHeaders> Update(string jobId, JobUpdateParameter jobUpdateParameter, JobUpdateOptions jobUpdateOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<DisableHeaders>> DisableAsync(string jobId, JobDisableParameter jobDisableParameter, JobDisableOptions jobDisableOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="jobDisableOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<DisableHeaders> Disable(string jobId, JobDisableParameter jobDisableParameter, JobDisableOptions jobDisableOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<EnableHeaders>> EnableAsync(string jobId, JobEnableOptions jobEnableOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="jobEnableOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<EnableHeaders> Enable(string jobId, JobEnableOptions jobEnableOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<TerminateHeaders>> TerminateAsync(string jobId, JobTerminateParameter jobTerminateParameter, JobTerminateOptions jobTerminateOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="jobTerminateOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<TerminateHeaders> Terminate(string jobId, JobTerminateParameter jobTerminateParameter, JobTerminateOptions jobTerminateOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<AddHeaders>> AddAsync(JobAddParameter job, JobAddOptions jobAddOptions, CancellationToken cancellationToken = default)
        {
            if (job == null)
            {
        ...
        /// <param name="jobAddOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<AddHeaders> Add(JobAddParameter job, JobAddOptions jobAddOptions, CancellationToken cancellationToken = default)
        {
            if (job == null)
            {
                throw new ArgumentNullException(nameof(job));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<CloudJobListResult, ListHeaders>> ListAsync(JobListOptions jobListOptions, CancellationToken cancellationToken = default)
        {
            using var scope = clientDiagnostics.CreateScope("JobClient.List");
            scope.Start();
            try
            {
        ...
        /// <param name="jobListOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<CloudJobListResult, ListHeaders> List(JobListOptions jobListOptions, CancellationToken cancellationToken = default)
        {
            using var scope = clientDiagnostics.CreateScope("JobClient.List");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<CloudJobListResult, ListFromJobScheduleHeaders>> ListFromJobScheduleAsync(string jobScheduleId, JobListFromJobScheduleOptions jobListFromJobScheduleOptions, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("JobClient.ListFromJobSchedule");
            scope.Start();
            try
            {
                using var message = CreateListFromJobScheduleRequest(jobScheduleId, jobListFromJobScheduleOptions);
                await pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                var headers = new ListFromJobScheduleHeaders(message.Response);
                switch (message.Response.Status)
                {
                    case 200:
                        {
        ...
        /// <param name="jobListFromJobScheduleOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<CloudJobListResult, ListFromJobScheduleHeaders> ListFromJobSchedule(string jobScheduleId, JobListFromJobScheduleOptions jobListFromJobScheduleOptions, CancellationToken cancellationToken = default)
        {
            if (jobScheduleId == null)
            {
                throw new ArgumentNullException(nameof(jobScheduleId));
        ...
        public async ValueTask<ResponseWithHeaders<CloudJobListPreparationAndReleaseTaskStatusResult, ListPreparationAndReleaseTaskStatusHeaders>> ListPreparationAndReleaseTaskStatusAsync(string jobId, JobListPreparationAndReleaseTaskStatusOptions jobListPreparationAndReleaseTaskStatusOptions, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = clientDiagnostics.CreateScope("JobClient.ListPreparationAndReleaseTaskStatus");
            scope.Start();
            try
            {
                using var message = CreateListPreparationAndReleaseTaskStatusRequest(jobId, jobListPreparationAndReleaseTaskStatusOptions);
                await pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                var headers = new ListPreparationAndReleaseTaskStatusHeaders(message.Response);
                switch (message.Response.Status)
                {
                    case 200:
                        {
        ...
        /// <param name="jobListPreparationAndReleaseTaskStatusOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<CloudJobListPreparationAndReleaseTaskStatusResult, ListPreparationAndReleaseTaskStatusHeaders> ListPreparationAndReleaseTaskStatus(string jobId, JobListPreparationAndReleaseTaskStatusOptions jobListPreparationAndReleaseTaskStatusOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<TaskCounts, GetTaskCountsHeaders>> GetTaskCountsAsync(string jobId, JobGetTaskCountsOptions jobGetTaskCountsOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
            ...
            try
            {
                ...
                await pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
                var headers = new GetTaskCountsHeaders(message.Response);
                switch (message.Response.Status)
                {
                    case 200:
                        {
                            TaskCounts value = default;
                            using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                            value = TaskCounts.DeserializeTaskCounts(document.RootElement);
                            return ResponseWithHeaders.FromValue(value, headers, message.Response);
                        }
                    default:
                        throw await clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
        ...
        /// <param name="jobGetTaskCountsOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<TaskCounts, GetTaskCountsHeaders> GetTaskCounts(string jobId, JobGetTaskCountsOptions jobGetTaskCountsOptions, CancellationToken cancellationToken = default)
        {
            if (jobId == null)
            {
                throw new ArgumentNullException(nameof(jobId));
        ...
        /// <param name="jobListOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<CloudJobListResult, ListHeaders>> ListNextPageAsync(string nextLink, JobListOptions jobListOptions, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
        ...
        /// <param name="jobListOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<CloudJobListResult, ListHeaders> ListNextPage(string nextLink, JobListOptions jobListOptions, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
        ...
        /// <param name="jobListFromJobScheduleOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<CloudJobListResult, ListFromJobScheduleHeaders>> ListFromJobScheduleNextPageAsync(string nextLink, string jobScheduleId, JobListFromJobScheduleOptions jobListFromJobScheduleOptions, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
        ...
        /// <param name="jobListFromJobScheduleOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<CloudJobListResult, ListFromJobScheduleHeaders> ListFromJobScheduleNextPage(string nextLink, string jobScheduleId, JobListFromJobScheduleOptions jobListFromJobScheduleOptions, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
        ...
        /// <param name="jobListPreparationAndReleaseTaskStatusOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<ResponseWithHeaders<CloudJobListPreparationAndReleaseTaskStatusResult, ListPreparationAndReleaseTaskStatusHeaders>> ListPreparationAndReleaseTaskStatusNextPageAsync(string nextLink, string jobId, JobListPreparationAndReleaseTaskStatusOptions jobListPreparationAndReleaseTaskStatusOptions, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
        ...
        /// <param name="jobListPreparationAndReleaseTaskStatusOptions"> Parameter group. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ResponseWithHeaders<CloudJobListPreparationAndReleaseTaskStatusResult, ListPreparationAndReleaseTaskStatusHeaders> ListPreparationAndReleaseTaskStatusNextPage(string nextLink, string jobId, JobListPreparationAndReleaseTaskStatusOptions jobListPreparationAndReleaseTaskStatusOptions, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
                throw new ArgumentNullException(nameof(nextLink));
