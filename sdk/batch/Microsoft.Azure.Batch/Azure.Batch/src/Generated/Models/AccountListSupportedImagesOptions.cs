...
namespace Azure.Batch.Models
{
    ...
    public partial class AccountListSupportedImagesOptions
    {
        ...
        internal AccountListSupportedImagesOptions(string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            Filter = filter;
