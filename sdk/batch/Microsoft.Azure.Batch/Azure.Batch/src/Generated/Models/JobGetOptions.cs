...
namespace Azure.Batch.Models
{
    ...
    public partial class JobGetOptions
    {
        ...
        internal JobGetOptions(string select, string expand, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, string ifMatch, string ifNoneMatch, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince)
        {
            Select = select;
            Expand = expand;
            Timeout = timeout;
