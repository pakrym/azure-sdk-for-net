...
namespace Azure.Batch.Models
{
    ...
    public partial class PoolListUsageMetricsOptions
    {
        ...
        internal PoolListUsageMetricsOptions(DateTimeOffset? startTime, DateTimeOffset? endTime, string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            StartTime = startTime;
            EndTime = endTime;
            Filter = filter;
