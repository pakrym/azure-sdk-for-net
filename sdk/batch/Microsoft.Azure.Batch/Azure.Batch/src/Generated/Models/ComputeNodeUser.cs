...
namespace Azure.Batch.Models
{
    ...
    public partial class ComputeNodeUser
    {
        ...
        /// <summary> Initializes a new instance of ComputeNodeUser. </summary>
        /// <param name="name"> The user name of the Account. </param>
        /// <param name="isAdmin"> The default value is false. </param>
        /// <param name="expiryTime"> If omitted, the default is 1 day from the current time. For Linux Compute Nodes, the expiryTime has a precision up to a day. </param>
        /// <param name="password"> The password is required for Windows Compute Nodes (those created with &apos;cloudServiceConfiguration&apos;, or created with &apos;virtualMachineConfiguration&apos; using a Windows Image reference). For Linux Compute Nodes, the password can optionally be specified along with the sshPublicKey property. </param>
        /// <param name="sshPublicKey"> The public key should be compatible with OpenSSH encoding and should be base 64 encoded. This property can be specified only for Linux Compute Nodes. If this is specified for a Windows Compute Node, then the Batch service rejects the request; if you are calling the REST API directly, the HTTP status code is 400 (Bad Request). </param>
        internal ComputeNodeUser(string name, bool? isAdmin, DateTimeOffset? expiryTime, string password, string sshPublicKey)
        {
            Name = name;
            IsAdmin = isAdmin;
