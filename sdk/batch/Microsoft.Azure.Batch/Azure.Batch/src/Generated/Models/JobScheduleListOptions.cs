...
namespace Azure.Batch.Models
{
    ...
    public partial class JobScheduleListOptions
    {
        ...
        internal JobScheduleListOptions(string filter, string select, string expand, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            Filter = filter;
            Select = select;
            Expand = expand;
