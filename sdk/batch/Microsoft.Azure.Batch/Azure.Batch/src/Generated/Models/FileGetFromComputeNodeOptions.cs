...
namespace Azure.Batch.Models
{
    ...
    public partial class FileGetFromComputeNodeOptions
    {
        ...
        internal FileGetFromComputeNodeOptions(int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, string ocpRange, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince)
        {
            Timeout = timeout;
