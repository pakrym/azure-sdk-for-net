...
namespace Azure.Batch.Models
{
    ...
    public partial class AccountListPoolNodeCountsOptions
    {
        ...
        internal AccountListPoolNodeCountsOptions(string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            Filter = filter;
