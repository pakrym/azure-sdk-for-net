...
namespace Azure.Batch.Models
{
    ...
    public partial class TaskListOptions
    {
        ...
        internal TaskListOptions(string filter, string select, string expand, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            Filter = filter;
            Select = select;
            Expand = expand;
