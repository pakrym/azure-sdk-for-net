...
namespace Azure.Batch.Models
{
    ...
    public partial class PoolListOptions
    {
        ...
        internal PoolListOptions(string filter, string select, string expand, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            Filter = filter;
            Select = select;
            Expand = expand;
