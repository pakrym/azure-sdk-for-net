...
namespace Azure.Batch.Models
{
    ...
    public partial class FileGetFromTaskOptions
    {
        ...
        internal FileGetFromTaskOptions(int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, string ocpRange, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince)
        {
            Timeout = timeout;
