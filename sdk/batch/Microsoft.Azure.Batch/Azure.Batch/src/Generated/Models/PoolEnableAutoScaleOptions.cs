...
namespace Azure.Batch.Models
{
    ...
    public partial class PoolEnableAutoScaleOptions
    {
        ...
        internal PoolEnableAutoScaleOptions(int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, string ifMatch, string ifNoneMatch, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince)
        {
            Timeout = timeout;
