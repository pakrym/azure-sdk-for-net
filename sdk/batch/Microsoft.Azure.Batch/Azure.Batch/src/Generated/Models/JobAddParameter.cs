...
namespace Azure.Batch.Models
{
    ...
    public partial class JobAddParameter
    {
        ...
        /// <param name="jobReleaseTask"> A Job Release Task cannot be specified without also specifying a Job Preparation Task for the Job. The Batch service runs the Job Release Task on the Nodes that have run the Job Preparation Task. The primary purpose of the Job Release Task is to undo changes to Compute Nodes made by the Job Preparation Task. Example activities include deleting local files, or shutting down services that were started as part of Job preparation. </param>
        ...
        internal JobAddParameter(string id, string displayName, int? priority, JobConstraints constraints, JobManagerTask jobManagerTask, JobPreparationTask jobPreparationTask, JobReleaseTask jobReleaseTask, IList<EnvironmentSetting> commonEnvironmentSettings, PoolInformation poolInfo, OnAllTasksComplete? onAllTasksComplete, OnTaskFailure? onTaskFailure, IList<MetadataItem> metadata, bool? usesTaskDependencies, JobNetworkConfiguration networkConfiguration)
        {
            Id = id;
