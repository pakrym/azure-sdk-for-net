...
namespace Azure.Batch.Models
{
    ...
    public partial class JobScheduleTerminateOptions
    {
        ...
        internal JobScheduleTerminateOptions(int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, string ifMatch, string ifNoneMatch, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince)
        {
            Timeout = timeout;
