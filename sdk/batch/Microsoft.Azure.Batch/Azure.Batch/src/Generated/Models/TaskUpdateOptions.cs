...
namespace Azure.Batch.Models
{
    ...
    public partial class TaskUpdateOptions
    {
        ...
        internal TaskUpdateOptions(int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate, string ifMatch, string ifNoneMatch, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince)
        {
            Timeout = timeout;
