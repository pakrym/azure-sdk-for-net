...
namespace Azure.Batch.Models
{
    ...
    public partial class CertificateListOptions
    {
        ...
        internal CertificateListOptions(string filter, string select, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            Filter = filter;
            Select = select;
