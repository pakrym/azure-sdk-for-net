...
namespace Azure.Batch.Models
{
    ...
    public partial class FileListFromComputeNodeOptions
    {
        ...
        internal FileListFromComputeNodeOptions(string filter, int? maxResults, int? timeout, Guid? clientRequestId, bool? returnClientRequestId, DateTimeOffset? ocpDate)
        {
            Filter = filter;
