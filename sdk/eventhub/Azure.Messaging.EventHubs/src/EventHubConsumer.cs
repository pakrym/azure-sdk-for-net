...
namespace Azure.Messaging.EventHubs
{
    ...
    public class EventHubConsumer : IAsyncDisposable
    {
        ...
        ///
        public virtual async IAsyncEnumerable<EventData> SubscribeToEvents(TimeSpan? maximumWaitTime, [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
