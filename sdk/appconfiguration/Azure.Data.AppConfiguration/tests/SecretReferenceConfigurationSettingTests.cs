...
namespace Azure.Data.AppConfiguration
{
    public class SecretReferenceConfigurationSettingTests
    {
        ...
        {
            var reference = new SecretReferenceValue("key", new Uri("http://example.com/secret"));
        ...
        {
            var featureFlag = new SecretReferenceValue();
        ...
        {
            var reference = new SecretReferenceValue("key", new Uri("http://example.org"));
        ...
        {
            var feature = new SecretReferenceValue();
