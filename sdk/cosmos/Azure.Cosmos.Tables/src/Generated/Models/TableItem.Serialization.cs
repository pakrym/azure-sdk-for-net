...
{
    public partial class TableItem : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static TableItem DeserializeTableItem(XElement element)
        {
            TableItem result = default;
            result = new TableItem(); string value = default;
