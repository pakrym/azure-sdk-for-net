...
namespace Microsoft.Extensions.Azure
{
    ...
    public sealed class AzureClientFactoryBuilder : IAzureClientFactoryBuilderWithConfiguration<IConfiguration>, IAzureClientFactoryBuilderWithCredential
    {
        ...
        {
            return RegisterClientFactory<TClient, TOptions>((options, credential, serviceProvider) => clientFactory(options, credential), requiresCredential);
        }
        ...
        {
            return RegisterClientFactory<TClient, TOptions>((options, credential, serviceProvider) => factory(options), false);
        }
        ...
        {
            return RegisterClientFactory<TClient, TOptions>((options, credential, serviceProvider) => factory(credential, options), true);
        }
        ...
        {
            return RegisterClientFactory<TClient, TOptions>((options, credential, serviceProvider) => factory(options, serviceProvider), false);
        }

        public IAzureClientBuilder<TClient, TOptions> AddClient<TClient, TOptions>(Func<TokenCredential, TOptions, IServiceProvider, TClient> factory) where TOptions : class
        {
            return RegisterClientFactory<TClient, TOptions>((options, credential, serviceProvider) => factory(credential, options, serviceProvider), false);
        }
